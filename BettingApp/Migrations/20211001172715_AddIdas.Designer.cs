...
namespace BettingApp.Migrations
{
    ...
    [Migration("20211001172715_AddIdas")]
    partial class AddIdas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BettingApp.Models.BetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.Models.Player", b =>
                {
            ...
            modelBuilder.Entity("BettingApp.Models.Bet", b =>
                {
                    b.HasOne("BettingApp.Models.BetType", "BetType")
                        .WithMany()
                        .HasForeignKey("BetTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BettingApp.Models.Player", "Player")
                        .WithMany("Bets")
